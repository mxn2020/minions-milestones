...
/**
 * @minions-milestones/cli — CLI for Minions Milestones
 *
...
import { customTypes } from '@minions-milestones/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Milestones'));
        console.log(chalk.dim('Milestone definitions, dependencies, and completion criteria'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-milestones/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-milestones/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-milestones')}`);
