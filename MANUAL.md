# Manual Setup Steps for Minions Milestones
...
Go to **GitHub → mxn2020/minions-milestones → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-milestones` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-milestones-web`
- **GitHub repo**: `mxn2020/minions-milestones`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `milestones.minions.wtf`

### Documentation
- **Netlify site name**: `minions-milestones-docs`
- **GitHub repo**: `mxn2020/minions-milestones`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `milestones.minions.help`

### Blog
- **Netlify site name**: `minions-milestones-blog`
- **GitHub repo**: `mxn2020/minions-milestones`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `milestones.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `milestones.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `milestones.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `milestones.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-milestones/sdk`](https://www.npmjs.com/package/@minions-milestones/sdk)
- CLI: [`@minions-milestones/cli`](https://www.npmjs.com/package/@minions-milestones/cli)
...
Your package: [`minions-milestones`](https://pypi.org/project/minions-milestones/)
...
| Item | Value |
|------|-------|
| Project | `minions-milestones` |
| SDK (npm) | `@minions-milestones/sdk` |
| CLI (npm) | `@minions-milestones/cli` |
| Python (PyPI) | `minions-milestones` |
| GitHub | `github.com/mxn2020/minions-milestones` |
| Docs domain | `milestones.minions.help` |
| Blog domain | `milestones.minions.blog` |
| App domain | `milestones.minions.wtf` |
